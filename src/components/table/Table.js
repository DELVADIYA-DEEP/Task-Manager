        ...
        <>
            ...
            ${task.status === 'Complete' ? 'btn-success' : 'btn-warning text-dark'}`}
                                            ...
                                            <td className='d-flex align-items-center justify-content-evenly'>
                                                <button
                                                    className='btn btn-sm btn-outline-primary fs-5 d-flex align-items-center justify-content-center'
                                                    title="View"
                                                ...
                                                <button
                                                    className='btn btn-sm btn-outline-success fs-5 d-flex align-items-center justify-content-center'
                                                    title="Edit"
                                                ...
                                                <button
                                                    className='btn btn-sm btn-outline-danger fs-5 d-flex align-items-center justify-content-center'
                                                    title="Delete"
